...
export default function ChiSonoPage() {
  ...
  return (
    <div className="tanit-page">
      <section style={{ padding:'140px 48px 60px', position:'relative' }}>
        ...
        <div style={{ position:'relative', zIndex:2, maxWidth:1160, margin:'0 auto' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 380px', gap:72, alignItems:'center', marginBottom:80 }}>
            <div>
              <h1 ref={h1.ref} style={{ ...h1.style, fontFamily:"'DM Serif Display',serif", fontSize:'clamp(2.6rem,6vw,5rem)', color:'var(--p1)', lineHeight:1.1, marginBottom:24 }}>
                La <em style={{ fontStyle:'italic', color:'var(--p3)' }}>clinica</em><br/>che incontra<br/>l'umano.
              </h1>
              <p ref={h2.ref} style={{ ...h2.style, fontSize:'1.18rem', fontWeight:300, lineHeight:1.9, color:'#3d1a6e', marginBottom:32 }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'340px 1fr', gap:72, alignItems:'start' }}>
            ...
            />
            <div>
              <div ref={p1.ref} style={{ ...p1.style, fontSize:'1.06rem', lineHeight:1.9, fontWeight:300, color:'#3d1a6e', marginBottom:22 }}>
              ...
              <div ref={p2.ref} style={{ ...p2.style, fontSize:'1.06rem', lineHeight:1.9, fontWeight:300, color:'#3d1a6e', marginBottom:22 }}>
              ...
              <div ref={p3.ref} style={{ ...p3.style, fontSize:'1.06rem', lineHeight:1.9, fontWeight:300, color:'#3d1a6e', marginBottom:22 }}>
              ...
              <div ref={p4.ref} style={{ ...p4.style, fontSize:'1.06rem', lineHeight:1.9, fontWeight:300, color:'#3d1a6e', marginBottom:40 }}>
                Il mio lavoro nasce sempre da un Patto: di rispetto reciproco, di presenza, di onestà.
              </div>
              ...
              <ValueItem icon={Search} title="Sguardo clinico"    delay={120} text="La formazione scientifica mi dà strumenti. L'intuizione mi aiuta a usarli nel modo giusto."/>
              <ValueItem icon={Wind}   title="Ritmo tuo"           delay={240} text="Nessun percorso è uguale. Nessuna fretta. Procediamo al tuo passo — e io resto lì."/>
              <ValueItem icon={Shield} title="Etica sempre"        delay={360} text="Riservatezza, rispetto, trasparenza. Il mio codice deontologico è la base, non il soffitto."/>
            </div>
          </div>
        </div>
      </section>

      <CtaSection title={<>Vuoi <span className="drawn">saperne di più</span>?</>} body="Hai domande? Scrivimi — la prima conversazione è gratuita e senza impegno." btnLabel="Scopri il Metodo"/>
      <Footer/>
    </div>
  );
}